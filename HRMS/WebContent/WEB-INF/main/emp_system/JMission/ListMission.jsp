...
ArrayList<Mission> missionList = (ArrayList<Mission>)request.getAttribute("missionList");
%>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link href="../emp/css/jquery.datatables.css" rel="stylesheet">
</head>
...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent"><a href=""><i class="fa fa-th-list"></i> <span>任务管理</span></a>
          <ul class="children">
            <li><a href="buttons.html"><i class="fa fa-caret-right"></i> 任务列表</a></li>
            <li><a href="icons.html"><i class="fa fa-caret-right"></i> 添加任务</a></li>
          </ul>
        </li>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-table"></i> 任务列表 <span>Subtitle goes here...</span></h2>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="dataTables_length" id="table2_length">
	          <div class="btn-demo" align="right" style="width: 40%">
	                <a href="<%=basePath %>CMission/intoMission" class="btn btn-darkblue">增加</a>
	          </div>
          </div>
