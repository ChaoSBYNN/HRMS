...
<head>
  ...
  <link rel="stylesheet" href="../emp/css/style.default.css" />
  
  <link rel="stylesheet" href="../emp/css/bootstrap-timepicker.min.css" />
  <link rel="stylesheet" href="../emp/css/jquery.tagsinput.css" />
  <link rel="stylesheet" href="../emp/css/colorpicker.css" />
  <link rel="stylesheet" href="../emp/css/dropzone.css" />
...
<section>
    ...
    <div class="leftpanelinner">
        ...
        <div class="visible-xs hidden-sm hidden-md hidden-lg">   
            <div class="media userlogged">
                <img alt="" src="../emp/images/photos/loggeduser.png" class="media-object">
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-edit"></i> 任务信息 <span>Subtitle goes here...</span></h2>
    ...
    <div class="contentpanel">
      ...
      <form class="form-horizontal form-bordered" action="<%=basePath%>CMission/insertMission" method="post">
      <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding">
          <input type="hidden" value="missionId" name="missionId" id="missionId" >
          <input type="hidden" value="<%=user.getUserId() %>" id="issuerId" name="issuerId" class="form-control" />
			<div class="form-group">
              <label class="col-sm-3 control-label">任务名称</label>
              <div class="col-sm-6">
                <input type="text" placeholder="任务名称" id="missionName" name="missionName" class="form-control" />
              </div>
            </div>
            
            <div class="form-group">
              <label class="col-sm-3 control-label">任务信息</label>
              <div class="col-sm-6">
                <input type="text" placeholder="任务信息" id="missionInfo" name="missionInfo" class="form-control" />
              </div>
            </div>
...
<script src="../emp/js/jquery.autogrow-textarea.js"></script>
<script src="../emp/js/bootstrap-timepicker.min.js"></script>
<script src="../emp/js/jquery.maskedinput.min.js"></script>
<script src="../emp/js/jquery.tagsinput.min.js"></script>
<script src="../emp/js/jquery.mousewheel.js"></script>
<script src="../emp/js/select2.min.js"></script>
<script src="../emp/js/dropzone.min.js"></script>
<script src="../emp/js/colorpicker.js"></script>
...
jQuery(document).ready(function(){
  ...
  // Input Masks
  jQuery("#enterdate").mask("99/99/9999");
  jQuery("#leavedate").mask("99/99/9999");
