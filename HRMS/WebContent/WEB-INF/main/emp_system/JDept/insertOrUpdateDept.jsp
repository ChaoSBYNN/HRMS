...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-edit"></i> 部门信息 <span>Subtitle goes here...</span></h2>
    ...
    <div class="contentpanel">
      ...
      <form class="form-horizontal form-bordered" action="<%=basePath%>CDept/insertDept" method="post">
        ...
        <div class="panel-body panel-body-nopadding">
          <input type="hidden" value="deptId" name="deptId" id="deptId" >
			<div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" placeholder="部门名称" id="deptName" name="deptName" class="form-control" />
              </div>
            </div>
