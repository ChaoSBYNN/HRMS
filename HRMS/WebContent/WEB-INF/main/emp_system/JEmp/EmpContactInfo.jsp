...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="contentpanel">
      ...
      <form class="form-horizontal form-bordered" action="<%=basePath %>CEmp/insertEmpContactInfo" method="post">
          	...
          	<input type="hidden" value="<%=emp.getEmpId() %>" name="empId" id="empId" >
	            ...
	            <div class="form-group" >
	              ...
	              <div class="input-group mb15">
	                ...
	                <input type="text" placeholder="办公电话" id="officePhone" name="officePhone" class="form-control" />
	              </div></div>
	            </div>
	            ...
	            <div class="form-group">
	              ...
	              <div class="input-group mb15">
	                <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
	                <input type="text" placeholder=家庭电话 id="homePhone" name="homePhone" class="form-control" />
	              </div></div>
	            </div>
	            ...
	            <div class="form-group">
	              ...
	              <div class="input-group mb15">
	                <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
	                <input type="text" placeholder="移动电话" id="mobilePhone" name="mobilePhone" class="form-control" />
	              </div></div>
	            </div>
	            ...
	            <div class="form-group">
	              ...
	              <div class="input-group mb15">
	                ...
	                <input type="text" placeholder="E-Mail" id="empEmail" name="empEmail" class="form-control" />
	              </div></div>
	            </div>
		        ...
		        <div class="form-group">
	              ...
	              <div class="input-group mb15">
	                ...
	                <input type="text" placeholder="地址" id="empAddress" name="empAddress" class="form-control" />
	              </div></div>
	            </div>
...
jQuery(document).ready(function(){
  ...
  // Input Masks
  jQuery("#office").mask("9999-99999999-999");
  jQuery("#home").mask("9999-99999999");
  jQuery("#phone").mask("999-999-99999");
