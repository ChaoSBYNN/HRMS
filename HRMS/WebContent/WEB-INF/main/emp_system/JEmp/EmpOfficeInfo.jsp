...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="contentpanel">
      ...
      <form class="form-horizontal form-bordered" action="<%=basePath%>CEmp/addEmpContactInfo" method="post">
          ...
          <input type="hidden" value="empId" name="empId" id="empId" >
            ...
            <div class="form-group">
             <label class="col-sm-3 control-label">出生日期</label>
            	<div class="col-sm-6">
                	<input type="text" placeholder="出生日期" id="date" name="empbirthday" class="form-control" />
              	</div>
            </div>
