...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="contentpanel">
      ...
      <form class="form-horizontal form-bordered" action="<%=basePath%>CEmp/insertEmpEducationInfo" method="post">
        ...
        <div class="panel-body panel-body-nopadding">
          <input type="hidden" value="<%=emp.getEmpId() %>" name="empId" id="empId" >
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" placeholder="学校名称" id="schoolName" name="schoolName" class="form-control" />
              </div>
            </div>
            
            <div class="form-group">
             <label class="col-sm-3 control-label">入校日期</label>
            	<div class="col-sm-6">
                	<input type="text" placeholder="入校日期" id="enterdate" name="enterdate" class="form-control" />
              	</div>
            </div>
            ...
            <div class="form-group">
             <label class="col-sm-3 control-label">离校日期</label>
            	<div class="col-sm-6">
                	<input type="text" placeholder="离校日期" id="leavedate" name="leavedate" class="form-control" />
              	</div>
            </div>
...
jQuery(document).ready(function(){
  ...
  // Input Masks
  jQuery("#enterdate").mask("9999-99-99");
  jQuery("#leavedate").mask("9999-99-99");
