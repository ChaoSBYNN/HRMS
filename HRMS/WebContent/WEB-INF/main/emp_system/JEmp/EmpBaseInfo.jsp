...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-edit"></i> 员工信息 <span>Subtitle goes here...</span></h2>
    ...
    <div class="contentpanel">
      ...
      <form class="form-horizontal form-bordered" action="<%=basePath%>CEmp/insertEmpBaseInfo" method="post">
      <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding">
          <input type="hidden" value="<%=emp.getEmpId() %>" name="empId" id="empId" >
            <div class="form-group">
              <label class="col-sm-3 control-label">姓名</label>
              <div class="col-sm-6">
                <input type="text" placeholder="姓名" id="empName" name="empName" class="form-control" />
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" placeholder="年龄" id="empAge" name="empAge" class="form-control" />
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" placeholder="身份证" id="idCard" name="idCard" class="form-control" />
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
					 <div class="radio" >
					 <label><input type="radio" name="empSex" id="empSex" checked="checked"> 男</label>
					 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					 <label><input type="radio" name="empSex" id="empSex"> 女</label></div>
				  </div>
            </div>
            ...
            <div class="form-group">
             <label class="col-sm-3 control-label">出生日期</label>
            	<div class="col-sm-6">
                	<input type="text" placeholder="出生日期" id="empBirthday" name="empBirthday" class="form-control" />
              	</div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <select class="form-control mb15" id="empEducation" name="empEducation">
                  <option>博士后</option>
                  <option>博士</option>
        ...
        <div class="panel-footer">
			 <div class="row">
				<div class="col-sm-6 col-sm-offset-3">
				  <button class="btn btn-primary">下一项</button>&nbsp;
...
jQuery(document).ready(function(){
  ...
  // Input Masks
  jQuery("#empBirthday").mask("9999-99-99");
