...
ArrayList<Station> stationList = (ArrayList<Station>)request.getAttribute("stationList");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-table"></i> 职位列表 <span>Subtitle goes here...</span></h2>
        ...
        <div class="panel-body">
          <div class="dataTables_length" id="table2_length">
	          <div class="btn-demo" align="right" style="width: 40%">
	                <a href="<%=basePath %>CStation/intoStation" class="btn btn-darkblue">增加</a>
	          </div>
          </div>
