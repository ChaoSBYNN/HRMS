...
<section>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-edit"></i> 职位信息 <span>Subtitle goes here...</span></h2>
    ...
    <div class="contentpanel">
      ...
      <form class="form-horizontal form-bordered" action="<%=basePath%>CStation/insertStation" method="post">
        ...
        <div class="panel-body panel-body-nopadding">
          <input type="hidden" value="stationId" name="stationId" id="stationId" >
			<div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" placeholder="职位名称" id="stationName" name="stationName" class="form-control" />
              </div>
            </div>
            
            <div class="form-group">
              <label class="col-sm-3 control-label">隶属部门</label>
              <div class="col-sm-6">
                <select class="form-control mb15" id="deptId" name="deptId">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">父级职位</label>
              <div class="col-sm-6">
                <select class="form-control mb15" id="fatherId" name="fatherId">
                  <option value="0"  selected="selected">1</option>
                  <option>2</option>
                  <option>3</option>
                  <option>4</option>
